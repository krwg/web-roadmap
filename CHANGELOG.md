...
### Added
- Интерактивные квизы «Проверь себя» (4 вопроса/неделя, мгновенный feedback)
- Переключатель трека Полный / Лайт с фильтрацией блоков практики
- Карта прогресса на главной + умный «Продолжить» (первый незакрытый день)
- Экспорт `progress.json` для learning-log / gist
- Страница Changelog на сайте (`#changelog`)
